...
def get_args():
    ...
    parser.add_argument('--mask_type', type=str, default='none',
                        choices=['none', 'iid', 'wor', 'layer_wise_wor', 'layer_wise_iid', 'lisa', 'lisa_wor', 'sift', 'golore'],
                        help='Type of gradient mask to apply: none, iid, or wor (without replacement)')
    
    parser.add_argument('--r', type=float, default=1.0,
                        help='Keep ratio of mask (0 < r ≤ 1)')

    parser.add_argument('--warm_up', type=int, default=10,
                    help='Number of warm-up epochs with full gradients before applying mask')
    
    parser.add_argument('--heuristics', default=False,
                    help='Whether to use heuristics for mask application (default: False)')
    
    parser.add_argument('--lazy', type=int, default=10,
                    help='Lazy parameter: generate masks every k cycles when heuristics=True and mask_type=wor')
    ...
    parser.add_argument('--sampling_layers', type=int, default=6, help='Number of layers to sample per epoch (for layer-wise mask without replacement)')

    parser.add_argument('--sampling_period', type=int, default=5, help='Number of epochs between sampling new layers (for layer-wise mask without replacement)')
