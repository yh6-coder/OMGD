...
from peft_pretraining.galore_torch import GaLoreAdamW, GaLoreAdamW8bit, GaLoreAdafactor
from peft_pretraining.golore_torch import GoLoreAdamW, GoLoreAdamW8bit
from peft_pretraining.galore_torch import SGD as GaLoreSGD
from peft_pretraining.golore_torch import SGD as GoLoreSGD
    ...
    def _inner_training_loop(
        ...
        if args.trainer == "zo_adam":
            ...
            if args.optimizer == "adam":
                ...
                self.optimizer = SGD(self.model.parameters(), lr=args.learning_rate, momentum=args.momentum, dampening=args.dampening, weight_decay=args.weight_decay)
            elif 'lore' in args.optimizer.lower():
                ...
                param_groups = [{'params': regular_params}, 
                                {'params': galore_params, 'rank': args.rank, 'update_proj_gap': args.update_proj_gap, 'scale': args.galore_scale, 'proj_type': args.proj_type, 'rand_epoch': args.rand_ratio * args.max_steps}]
                if args.optimizer.lower() == "galore_adamw":
                    self.optimizer = GaLoreAdamW(param_groups, lr=args.learning_rate, weight_decay=args.weight_decay)
                elif args.optimizer.lower() == "golore_adamw":
                    self.optimizer = GoLoreAdamW(param_groups, lr=args.learning_rate, weight_decay=args.weight_decay)
                elif args.optimizer.lower() == "galore_sgd":
                    self.optimizer = GaLoreSGD(param_groups, lr=args.learning_rate, momentum=args.momentum, dampening=args.dampening, weight_decay=args.weight_decay)
                    # optimizer = GaLoreSGD(self.model.parameters(), lr=args.learning_rate, weight_decay=args.weight_decay)
                elif args.optimizer.lower() == "golore_sgd":
                    self.optimizer = GoLoreSGD(param_groups, lr=args.learning_rate, momentum=args.momentum, dampening=args.dampening, weight_decay=args.weight_decay)
