...
from .Hybrid_projector import Hybrid_projector
            ...
            for p in group["params"]:
                ...
                if "rank" in group:
                    if "projector" not in state:
                        state["projector"] = Hybrid_projector(group["rank"], update_proj_gap=group["update_proj_gap"], scale=group["scale"], proj_type=group["proj_type"])
